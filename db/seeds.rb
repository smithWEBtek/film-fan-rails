...
User.create(username: 'georgecostanza', email: 'george@abc.com', password: 'password')

Genre.create!([{name: 'Action'},  {name: 'rom-com'}])

Movie.create!(title: "Dark Knight Rises", director: "Nolan", year: 2008, description: "A new take on a superhero film.", user_id: 1, genre_id: 1)
...
User.create!( email: "shavon@gmail.com", password: "12345679")
